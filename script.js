...
var h1=document.querySelector('.hero h1');if(h1){var html=h1.innerHTML.replace(/<em[^>]*>(.*?)<\/em>/g,'<span class="hl">$1</span>');var words=html.split(' ');h1.innerHTML=words.map(function(w,i){return '<span class="word-reveal" style="animation-delay:'+(i*0.08+0.3)+'s">'+w+'</span>'}).join(' ')}
