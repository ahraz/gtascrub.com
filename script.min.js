...
/* DISABLED — ── Page transitions ── (replaced by new animation stack) *//* ── Hero floating particles ── */
...
/* DISABLED — ── Word-reveal headline ── (replaced by new animation stack) *//* ── Cursor glow (desktop only) ── */
...
/* DISABLED — ── Scroll-to-top ── (replaced by new animation stack) *//* DISABLED — ── Stats counter animation ── (replaced by new animation stack) *//* ── Pricing Calculator ── */
...
function updateCalc(){
  ...
  var el=document.getElementById('calcTotal');if(el){el.textContent='$'+Math.round(total);}
}
...
/* DISABLED — ── FAQ Accordion v2 ── (replaced by new animation stack) *//* DISABLED — ── Chat Bubble v2 ── (replaced by new animation stack) *//* ── Area Checker ── */
...
/* DISABLED — ── Testimonial Auto-Scroll Carousel ── (replaced by new animation stack) *//* ── Blog Filter ── */
